...
class GIPC
{
  ...
  public:
    ...
    gipc::Json replay_frozen_fine(const std::string& directory,const std::string& output,device_TetraData& mesh);
    gipc::Json line_search_rollback_self_test(device_TetraData& mesh);
    ...
    void buildCP();
    void ensure_collision_pair_capacity(uint32_t discrete_required,uint32_t ccd_required);
