...
| Guarded candidate adoption | `agipc_galerkin.cu`: `adopt_galerkin_candidate`; `global_linear_system.cu`: `solve_linear_system` | Requires a complete map and passes dimension, finite-value, descent and residual-growth gates; otherwise runs the original fine solver and accumulates typed fallback reasons |
