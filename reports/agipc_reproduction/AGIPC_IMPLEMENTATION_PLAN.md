...
- [ ] Add sparse, low-volume same-run state summaries to locate the first material nonlinear divergence. Freeze only the first informative H/g and pair criterion connectivity, direction quality and contact-set summaries there.
