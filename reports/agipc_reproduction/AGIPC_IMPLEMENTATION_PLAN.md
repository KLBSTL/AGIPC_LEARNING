...
- [ ] Before more performance/paper integration, trace the giant affine groups' criterion history/protected-edge propagation and hierarchical merges. Capture only necessary missing positions/protection/history after narrowing the cause; preserve default post10/paper threshold.
