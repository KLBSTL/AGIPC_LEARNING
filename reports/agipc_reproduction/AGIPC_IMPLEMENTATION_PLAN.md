...
- [ ] Before more performance/paper integration, freeze representative full fine H/g and compare prolonged, bounded-post and full-fine reference directions on the same system. Locate state divergence with sparse checkpoints and independently verify a captured local rejection.
